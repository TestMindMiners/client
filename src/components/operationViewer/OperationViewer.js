...
export default function OperationViewer(props) {
  const operationDate = new Date(
    props.operationData.operationDate
  ).toLocaleDateString();
  ...
  return (
    <div className="operation_viewer">
      <fieldset className="view_status">
        ...
        <label className="value_result">{props.operationData.id}</label>
        <label className="value_title">Data da Operação</label>
        <label className="value_result">{operationDate}</label>
        ...
        <label className="value_title">
          Valor de Imposto de Renda Calculado
        </label>
        <label className="value_result">{props.operationData.irValue}</label>
        ...
        <label className="value_result">{createAt}</label>
      </fieldset>
    </div>
  );
}
